# Generated by Powerlevel10k configuration wizard on 2025-07-04 at 12:43 CST.
...
typeset -g POWERLEVEL9K_MY_DOCKER_INDICATOR_BACKGROUND=transparent
typeset -g POWERLEVEL9K_MY_DOCKER_INDICATOR_FOREGROUND=transparent
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
    ...
    # =========================[ Line #2 ]=========================
    newline                   # \n
    my_docker_indicator       # custom Docker indicator
